...
- Added: **a police car in front drags you down.** Being behind a cruiser or an Interceptor in its
  line forces your car toward a stop, whatever the throttle says, until you swing aside. The same
  zone works in INTERCEPT, where your police car does it to the racers.
  [RLG-259](../fragments/RLG-259.md)
...
- Changed: **three stars allow one Interceptor, four allow two.** Three stars allowed two, because the
  old count rounded up. The trigger is unchanged. [RLG-262](../fragments/RLG-262.md)
...
- Changed: **speed traps chase you again.** With the rogue trap fixed, SPEED TRAPS ENGAGE in
  OPTIONS > DEBUG boots ON again, as it did before the test. [RLG-253](../fragments/RLG-253.md)
...
- Changed: **the light bar is dark when unlit and saturated when lit, like its small emergency
  lamps**, on both police cars and the ambulance. A roadblock cruiser in the mirror no longer has a
  flat bar painted above its roof; it flashes its own lamps. [RLG-243](../fragments/RLG-243.md)
